            ...
            xhr.onload = function() {
                if (xhr.status === 200) {
                    ...
                    if (responseData.hasOwnProperty('repackProducts')) {
                        ...
                        console.log(repackProducts.length);
        ...
        $(document).ready(function(){
            $('.editable-log_status').hover(function(){
                ...
                if (description) {
                    ...
                    popup.css({
                        display: "block",
                        top: (optionOffset.top + optionHeight + 10) + "px",
                        left: (optionOffset.left + 10) + "px"
                    });

            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="productForm">
                        ...
                        {{-- <div id="chip-container-label">Selected Barcode/QR Code :</div>
                        <div id="selected_sku" class="chip-container"></div> --}}
                        <!-- Add other form groups for the remaining input fields -->

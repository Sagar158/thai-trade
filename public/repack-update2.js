$(document).ready(function () {
    ...
    $(document).on('click', '.upload-product-image',function () {
        var attribute = $(this).data('attribute');
        var id = $(this).data('id');
        var td = $(this).closest('td');

        console.log(id , td);
        handleProductImageUpload(id, attribute, td);

    });


    function handleProductImageUpload(id, attribute, td) {
        var fileInput = document.createElement('input');
        fileInput.type = 'file';
        fileInput.accept = 'image/*';
        ...
        fileInput.onchange = function () {
            ...
            var url = '/product-image/' + id + '/' + attribute;
            $.ajax({
                type: 'POST',
                url: base_url+url,
                data: formData,

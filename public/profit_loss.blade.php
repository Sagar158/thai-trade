...
<section>
    ...
    {!! Form::open(['id' => 'dateForm', 'route' => 'report.profitLossData', 'method' => 'post']) !!}
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('.daterangepicker-field').on('apply.daterangepicker', function(ev, picker) {
            $.ajax({
                url: '/route-to-profitLossData',  // Update with the actual route
                type: 'POST',
                data: {
                    start_date: picker.startDate.format('YYYY-MM-DD'),
                    end_date: picker.endDate.format('YYYY-MM-DD'),
                    _token: '{{ csrf_token() }}'  // Ensure CSRF token is included if POST
                },
                success: function(data) {
                    console.log(data);  // Handle your data to update the DOM
                    // Update your front end components as needed
                },

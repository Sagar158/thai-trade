$(document).ready(function () {
    ...
    $('#repack_product').on('click', function () {
        ...
        $('.row-checkbox:checked').each(function () {
            ...
            var weight = $(this).attr('data-tweight');
            ...
            productH_Value = productH_Value + parseFloat(productH);
   	        product_weight_Value +=  parseFloat(productweight);



            // console.log('Weight Value : '+product_weight_Value);

            var tcube = $(this).attr('data-tcube');

            tpcs = tpcs + parseInt(productTpcs);
            weightValue = parseFloat(weightValue) + parseFloat(weight);
            tcubeValue += parseFloat(tcube);
        ...
        if (selectedRows.length > 0) {
            ...
            $('.row-checkbox:checked').each(function () {
               ...
               if (image1Value !== null && image1Value !== undefined) {
                    ...
                    $('#photo1').html(`<a href="#" class="view-image image1" data-bs-toggle="modal" data-bs-target="imageModal" data-image="${image1Value}"><img src="assets/images/picture.png" alt="Photo 1"></a>`);
                ...
                if (image2Value !== null && image2Value !== undefined) {
                    ...
                    $('#photo2').html(`<a href="#" class="view-image image2" data-bs-toggle="modal" data-bs-target="#imageModal" data-image="${image2Value}"><img src="assets/images/picture.png" alt="Photo 2"></a>`);
                ...
                if (image3Value !== null && image3Value !== undefined) {
                    ...
                    $('#photo3').html(`<a href="#" class="view-image image3" data-bs-toggle="modal" data-bs-target="#imageModal" data-image="${image3Value}"><img src="assets/images/picture.png" alt="Photo 3"></a>`);
                ...
                if (image4Value !== null && image4Value !== undefined) {
                    ...
                    $('#photo4').html(`<a href="#" class="view-image image4" data-bs-toggle="modal" data-bs-target="#imageModal" data-image="${image4Value}"><img src="assets/images/picture.png" alt="Photo 4"></a>`);
